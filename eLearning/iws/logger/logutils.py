...
def generate_request_id(original_request_id=''):
...
def request_id():
    ...
    request_id = generate_request_id(original_request_id)
...
def print_request_id():
    ...
    print(f"Next requestId: {generate_request_id(requestId)}")
    print(f"Last requestId: {generate_request_id(requestId)}")
    print()
